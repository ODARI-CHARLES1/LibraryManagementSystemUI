  ...
  return (
    <div className="w-full flex items-center justify-center lg:justify-between flex-wrap gap-3 md:gap-5">
      {summaryData.map((item, idx) => (
        <div
          key={idx}
          className={`bg-white rounded-md transition duration-500 w-full sm:w-[calc(50%-0.75rem)] 
          md:w-[calc(33.333%-1rem)] lg:w-[200px] hover:scale-105 cursor-pointer h-30 
          flex items-start p-3 gap-2 justify-center flex-col border-b-4 ${item.border}`}
        >
